  ...
  (defvar context-atomicl
    (make-mu4e-context
     ...
     :vars '((user-mail-address   . "vselvarajah@atomicl.net")
             ...
             (smtpmail-stream-type  . ssl)
             (mu4e-drafts-folder  . "/atomicl.net/primary/vselvarajah@atomicl.net/Draft")
             ...
             (mu4e-maildir-shortcuts . (("/atomicl.net/primary/vselvarajah@atomicl.net/Inbox"         . ?i)
                                        ...
                                        ("/atomicl.net/primary/vselvarajah@atomicl.net/Draft"         . ?d)))
             )))
#+end_src
  ...
  (use-package mu4e
    ...
    (setq mu4e-bookmarks
          '((:name "All Inboxes" :query "maildir:/vithurshan@laposte.net/Inbox OR m:/vithurshanselvarajah@gmail.com/Inbox OR m:/atomicl.net/primary/vselvarajah@atomicl.net/Inbox OR m:/atomicl.net/secondary/vselvarajah@atomicl.net/Inbox" :key ?i)
            (:name "Sent Items" :query "m:/vithurshan@laposte.net/Sent\\ Items OR m:/vithurshanselvarajah@gmail.com/[Gmail]/Messages\\ envoy&AOk-s OR m:/vselvarajah@atomicl.net/Sent" :key ?s)
            (:name "Deleted Mails" :query "m:/vithurshan@laposte.net/Deleted\\ Items OR m:/vithurshanselvarajah@gmail.com/[Gmail]/Corbeille OR m:/vselvarajah@atomicl.net/Trash" :key ?t)
            (:name "Draft Mails" :query "m:/vithurshan@laposte.net/DRAFT OR m:/vithurshanselvarajah@gmail.com/[Gmail]/Brouillons OR m:/vselvarajah@atomicl.net/Draft" :key ?d)
            (:name "Today's messages" :query "(m:/vithurshan@laposte.net/Inbox OR m:/vithurshanselvarajah@gmail.com/Inbox OR OR m:/vselvarajah@atomicl.net/Inbox) AND date:today..now" :key ?n)
            (:name "Last 7 days" :query "(m:/vithurshan@laposte.net/Inbox OR m:/vithurshanselvarajah@gmail.com/Inbox OR OR m:/vselvarajah@atomicl.net/Inbox) AND date:7d..now" :hide-unread t :key ?w)
