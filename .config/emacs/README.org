...
#+begin_src emacs-lisp :results none :tangle ./mails/mu4e-context-atomicl.el
  (defvar context-atomicl
    (make-mu4e-context
     ...
     (lambda (msg)
       (when msg
         (string-prefix-p "/vselvarajah@atomicl.net" (mu4e-message-field msg :maildir))))
     :vars '((user-mail-address   . "vselvarajah@atomicl.net")
             ...
             (smtpmail-stream-type  . ssl)
             (mu4e-drafts-folder  . "/vselvarajah@atomicl.net/Draft")
             (mu4e-sent-folder    . "/vselvarajah@atomicl.net/Sent")
             (mu4e-trash-folder   . "/vselvarajah@atomicl.net/Trash")
             (mu4e-maildir-shortcuts . (("/vselvarajah@atomicl.net/Inbox"         . ?i)
                                        ("/vselvarajah@atomicl.net/Sent"          . ?s)
                                        ("/vselvarajah@atomicl.net/Trash"         . ?t)
                                        ("/vselvarajah@atomicl.net/Draft"         . ?d)))
             )))
#+end_src
...
#+begin_src emacs-lisp :results none
  ...
  (use-package mu4e
    ...
    ;; Bookmarks
    (setq mu4e-bookmarks
          '((:name "All Inboxes" :query "maildir:/vithurshan@laposte.net/Inbox OR m:/vithurshanselvarajah@gmail.com/Inbox OR m:/vselvarajah@atomicl.net/Inbox" :key ?i)
