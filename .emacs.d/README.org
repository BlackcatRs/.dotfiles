...
;; Refiling or moving uwanted item usually finised tasks to diffrent place for archive purpose
...
;; Predified tags that can accesible from any org file
(setq org-tag-alist
      '((:startgroup)
	(:endgroup)
	("@errand" . ?E)
...
;; Dispaly final state of captured item in agenda view in order to track what happen, for example DONE or CANCELLED
