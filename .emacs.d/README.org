...
;; Capture tasks
(setq org-capture-templates
      '(("t" "TODO" entry (file+headline "tasks.org" "Collect")
         "* TODO %? %^G \n  %U" :empty-lines 1)

        ("s" "Scheduled TODO" entry (file+headline "tasks.org" "Collect")
         "* TODO %? %^G \nSCHEDULED: %^t\n  %U" :empty-lines 1)

        ("d" "Deadline" entry (file+headline "tasks.org" "Collect")
         "* TODO %? %^G \n  DEADLINE: %^t" :empty-lines 1)

        ("p" "Priority" entry (file+headline "tasks.org" "Collect")
         "* TODO [#A] %? %^G \n  SCHEDULED: %^t")

        ("a" "Appointment" entry (file+headline "tasks.org" "Collect")
         "* %? %^G \n  %^t")

        ("n" "Note" entry (file+headline "tasks.org" "Notes")
         "* %? %^G\n%U" :empty-lines 1)
...
(setq org-capture-templates
	...
	("j" "Journal" entry (file+datetree "~/lab/emacs/test_files/journal.org")
         "* [%<%H:%M>]\n %?" :empty-lines 1)
	))
